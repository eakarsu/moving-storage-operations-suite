...
const features = [
  {
    ...
    summary: 'Records workflow normalized for the Moving Storage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Users,
    summary: 'Workspaces workflow normalized for the Moving Storage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ClipboardList,
    summary: 'Requests workflow normalized for the Moving Storage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: CalendarCheck,
    summary: 'Cases workflow normalized for the Moving Storage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Activity,
    summary: 'Schedules workflow normalized for the Moving Storage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Workflow,
    summary: 'Resources workflow normalized for the Moving Storage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: FileText,
    summary: 'Approvals workflow normalized for the Moving Storage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ShieldCheck,
    summary: 'Exceptions workflow normalized for the Moving Storage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: BarChart3,
    summary: 'Compliance workflow normalized for the Moving Storage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: PackageCheck,
    summary: 'Analytics workflow normalized for the Moving Storage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Bell,
    summary: 'Forecasts workflow normalized for the Moving Storage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Intelligence Layer',
    icon: Files,
    summary: 'Reports workflow normalized for the Moving Storage Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Workflow,
    summary: "Moving Estimates elevated from the Moving Company source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Moving Estimates queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Moving Estimates", value: "24", note: 'Active' },
      { label: 'Review', value: "4", note: 'Needs attention' },
      { label: 'Due Soon', value: "3", note: 'Next 14 days' },
    ],
  },
  {
    slug: "crew-truck-scheduling",
    title: "Crew/Truck Scheduling",
    href: "/crew-truck-scheduling",
    category: "Moving Company",
    icon: Workflow,
    summary: "Crew/Truck Scheduling elevated from the Moving Company source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Crew/Truck Scheduling queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Crew/Truck Scheduling", value: "33", note: 'Active' },
      { label: 'Review', value: "5", note: 'Needs attention' },
      { label: 'Due Soon', value: "4", note: 'Next 14 days' },
    ],
  },
  {
    slug: "move-day-exceptions",
    title: "Move Day Exceptions",
    href: "/move-day-exceptions",
    category: "Moving Company",
    icon: Workflow,
    summary: "Move Day Exceptions elevated from the Moving Company source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Move Day Exceptions queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Move Day Exceptions", value: "42", note: 'Active' },
  ...
  },
  {
    ...
    icon: Files,
    summary: 'Moving Storage Operations documents, packets, evidence, attachments, and exports.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Bell,
    summary: 'Moving Storage Operations alerts, reminders, exceptions, and approvals.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Plug,
    summary: 'Moving Storage Operations source-system connector health and sync status.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: UserRound,
    summary: 'Moving Storage Operations users, roles, teams, permissions, and ownership settings.',
...
const aiFeatures = [
  {
    ...
    category: 'Intelligence Layer',
    icon: Bot,
    summary: 'Moving Storage Operations assistant for triage, summaries, drafting, recommendations, and operational review.',
...
export const featureFamilies = [
  ...
  { name: 'Moving Company', features: ["Moving Estimates","Crew/Truck Scheduling","Move Day Exceptions"] },
...
export const featureContexts: Record<string, FeatureContext> = Object.fromEntries(
  allFeatures.map((feature) => [
    feature.title,
    {
      sourceOwners: ['AIMovingStorageOperationsAssistant', 'AIMovingStorageOperationsOperations where applicable'],
