...
const entitySeeds = [
  ...
  ["moving-estimates","Moving Estimates Records","Moving Estimates operating queue","Open","Moving Estimates follow-up list","Moving Company","$0"],
  ["crew-truck-scheduling","Crew/Truck Scheduling Records","Crew/Truck Scheduling operating queue","Review","Crew/Truck Scheduling follow-up list","Moving Company","$0"],
  ["move-day-exceptions","Move Day Exceptions Records","Move Day Exceptions operating queue","Review","Move Day Exceptions follow-up list","Moving Company","$0"],
