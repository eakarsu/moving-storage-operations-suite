...
const featureSeeds = [
  ...
  ["moving-estimates","Moving Estimates","Moving Estimates review queue","Moving Company","Review source context and assign owner"],
  ["crew-truck-scheduling","Crew/Truck Scheduling","Crew/Truck Scheduling review queue","Moving Company","Confirm next action and update evidence"],
  ["move-day-exceptions","Move Day Exceptions","Move Day Exceptions review queue","Moving Company","Confirm next action and update evidence"],
