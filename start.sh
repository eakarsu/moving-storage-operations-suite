...
PORT="${PORT:-5440}"
DB_NAME="${PGDATABASE:-moving_storage_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Moving Storage Operations Suite"
echo "======================================="
echo
...
echo "Starting moving storage operations suite frontend on http://localhost:$PORT"
echo "Login: admin@moving-storage-operations.local / admin123"
